...
class AcceptMedicationVerificationRequest extends FormRequest
{
    ...
    {
        $productId = $this->route('medication')?->product_id;

        return [
            'trade_name' => ['required', 'string', 'max:255', 'unique:products,name,'.$productId],
